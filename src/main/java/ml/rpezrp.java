...
public class rpezrp implements CommandExecutor {
    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        if (args.length == 1 && args[0].equals("help")){
            sender.sendMessage(ChatColor.RED + "EasyRolePlayPlugin1.0 - Help");
            sender.sendMessage(ChatColor.RED + "由于技术原因,暂时无法制作附近消息,只能全服消息");
            sender.sendMessage(ChatColor.GREEN + "ezrp help - 帮助中心");
            ...
            sender.sendMessage(ChatColor.RED + "EasyRolePlayPlugin");
            sender.sendMessage("版本:1.0");
            sender.sendMessage("作者:低调不是很低调");
            sender.sendMessage("作者BILIBILI:https://space.bilibili.com/593929739");
            sender.sendMessage("在Github上为我点Star:https://github.com/SHIFTBLUEGA/EasyRolePlay");
